...
function GirisContent() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (subscribe && data.session?.access_token) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-lg">
        ...
        <h1 className="text-xl font-bold text-slate-900 mb-6">{titles[mode]}</h1>
        ...
        {mode === "login" && (
          <>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label htmlFor="giris-email" className="block text-sm font-medium text-slate-700 mb-1">
                  E-posta
                </label>
                <input
                  id="giris-email"
              ...
              <div>
                <label htmlFor="giris-password" className="block text-sm font-medium text-slate-700 mb-1">
                  Şifre
                </label>
                <input
                  id="giris-password"
