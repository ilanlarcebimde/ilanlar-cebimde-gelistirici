          ...
          <div className="flex min-w-0 flex-col gap-2 rounded-xl border border-slate-200 bg-slate-50 p-2.5">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              <button
                ...
                className="flex h-[64px] items-center rounded-xl border border-slate-200 bg-white px-3 py-2 text-left text-[12px] leading-tight transition hover:border-slate-300 hover:bg-slate-50"
              >
              ...
              <button
                ...
                className="flex h-[64px] items-center rounded-xl border border-slate-200 bg-white px-3 py-2 text-left text-[12px] leading-tight transition hover:border-slate-300 hover:bg-slate-50"
              >
                <span className="text-[11px] font-semibold leading-4 text-slate-900 whitespace-nowrap">İş Başvuru Mektubu Oluştur</span>
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1.5">
              ...
              <Link
                href="/"
                className="flex h-[64px] items-center rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-left text-[12px] leading-tight transition hover:border-orange-300 hover:bg-orange-100/70"
              >
                <span className="block text-[11px] font-medium leading-4 text-slate-900">Ücretsiz Vize Danışmanlığı · 24 Saatte Danışman Atanır</span>
              </Link>
            </div>
          </div>
        </div>
