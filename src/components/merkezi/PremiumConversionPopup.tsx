...
export function PremiumConversionPopup() {
  ...
  return createPortal(
    ...
    >
      ...
      {/* Scroll alanı; içerik uzarsa kaydırılır, kart ortada */}
      <div className="absolute inset-0 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4 sm:p-6">
          {/* Kart — header'ın üstünde kalması için z-[10000] */}
          <div
            className="merkezi-popup-in relative z-[10000] w-full max-w-lg overflow-hidden rounded-[28px] border border-white/10 shadow-[0_24px_80px_rgba(0,0,0,0.5)]"
          ...
          >
            <button
              type="button"
              onClick={handleClose}
              className="absolute right-3 top-3 z-10 rounded-full p-1.5 text-slate-400 transition-colors hover:bg-slate-700/50 hover:text-white"
              aria-label="Kapat"
            >
