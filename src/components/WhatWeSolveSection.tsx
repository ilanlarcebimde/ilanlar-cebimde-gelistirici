      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {CARDS.map((card, i) => (
            <motion.div
              key={card.problem}
              className="rounded-2xl border border-slate-200 bg-slate-50/50 p-6 shadow-[0_1px_3px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-[0_6px_20px_rgba(0,0,0,0.07)]"
